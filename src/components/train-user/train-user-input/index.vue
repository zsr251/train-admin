<template>
	...
	<train-user-dialog v-if="!disabled && visible" :key="visible" v-model="visible" :multiple @select="userHandle"></train-user-dialog>
</template>

<script setup lang="ts" name="TrainUserInput">
