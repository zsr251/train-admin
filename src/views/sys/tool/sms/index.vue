<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			<el-form-item prop="platform">
				<train-dict-select v-model="state.queryForm.platform" dict-type="sms_platform" clearable placeholder="平台类型"></train-dict-select>
			</el-form-item>
	...
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" @selection-change="selectionChangeHandle">
			...
			<train-dict-column prop="platform" label="平台类型" dict-type="sms_platform"></train-dict-column>
