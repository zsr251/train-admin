	...
	<el-dialog v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" draggable>
		<el-form ref="dataFormRef" :model="dataForm" :rules="dataRules" label-width="120px" @keyup.enter="submitHandle()">
			...
			<el-form-item prop="pid" label="上级机构">
				<train-org-select v-model="dataForm.pid" placeholder="请选择"></train-org-select>
			</el-form-item>
			<el-form-item prop="leaderId" label="负责人">
				<train-user-input v-model="dataForm.leaderId" placeholder="机构负责人"></train-user-input>
			</el-form-item>
...
import MaUserInput from '@/components/train-user/train-user-input/index.vue'
import MaOrgSelect from '@/components/train-org/train-org-select/index.vue'
