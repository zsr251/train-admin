		...
		>
			...
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="260">
				<template #default="scope">
					...
					<el-button type="primary" link @click="refreshCache(scope.row.dictType)">刷新缓存</el-button>
...
import { useDictTypeListApi,refreshDictApi } from '@/api/sys/dict'
...
const refreshCache = (dictType: string) => {
	refreshDictApi({
		dictType: dictType
	}).then(() => {
		// 提醒刷新
