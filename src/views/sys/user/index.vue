<template>
	<el-row :gutter="10">
		<el-col :span="5">
			<train-data-tree-left url="/sys/org/list" title="机构列表" tree-data @click="handleClick" @manage="treeVisible = true" />
		</el-col>
		<el-col :span="19">
			<el-card class="layout-query">
				<el-form ref="queryRef" :inline="true" :model="state.queryForm">
					...
					<el-form-item prop="gender">
						<train-dict-select v-model="state.queryForm.gender" dict-type="user_gender" clearable placeholder="性别"></train-dict-select>
					</el-form-item>
					<el-form-item>
			...
			<el-card>
				<el-space>
					...
					<el-space v-auth="'sys:user:import'">
						<train-upload-excel action="/sys/user/import">
				...
				>
					...
					<train-dict-column prop="status" label="状态" dict-type="user_status"></train-dict-column>
