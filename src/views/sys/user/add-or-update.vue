			...
			<el-row>
				<el-col :span="12">
					...
					<el-form-item prop="orgId" label="所属机构">
						<train-org-select v-model="dataForm.orgId" placeholder="请选择"></train-org-select>
					</el-form-item>
				...
				<el-col :span="12">
					...
					<el-form-item prop="status" label="状态">
						<train-dict-radio v-model="dataForm.status" dict-type="user_status"></train-dict-radio>
					</el-form-item>
				</el-col>
			</el-row>
		</el-form>
