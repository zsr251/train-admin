<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="paramType">
				<train-dict-select v-model="state.queryForm.paramType" dict-type="params_type" placeholder="系统参数" clearable></train-dict-select>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		>
			...
			<train-dict-column prop="paramType" label="系统参数" dict-type="params_type"></train-dict-column>
			<el-table-column prop="remark" label="备注" header-align="center" align="center"></el-table-column>
			<el-table-column prop="createTime" label="创建时间" header-align="center" align="center"></el-table-column>
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="180">
				<template #default="scope">
					<el-button type="primary" link @click="addOrUpdateHandle(scope.row.id)">修改 </el-button>
					<el-button type="primary" link @click="refreshParams(scope.row.paramKey)">刷新缓存 </el-button>
...
import {refreshParamsApi} from '@/api/sys/params'
...
const refreshParams = (paramKey: string) => {
	refreshParamsApi({paramKey: paramKey}).then(() => {
		// 通知成功
		ElMessage.success({
			message: '刷新成功',
			duration: 500
