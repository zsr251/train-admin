<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="status">
				<train-dict-select v-model="state.queryForm.status" dict-type="success_fail" placeholder="登录状态" clearable></train-dict-select>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		>
			...
			<train-dict-column prop="status" label="登录状态" dict-type="success_fail"></train-dict-column>
			<train-dict-column prop="operation" label="操作信息" dict-type="login_operation"></train-dict-column>
