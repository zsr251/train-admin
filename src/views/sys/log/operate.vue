<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="status">
				<train-dict-select v-model="state.queryForm.status" placeholder="操作状态" dict-type="success_fail" clearable> </train-dict-select>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		>
			...
			<train-dict-column prop="operateType" label="操作类型" dict-type="log_operate_type" header-align="center" align="center"></train-dict-column>
			...
			<train-dict-column prop="status" label="操作状态" dict-type="success_fail"></train-dict-column>
