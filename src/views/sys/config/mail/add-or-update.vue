	...
	<el-drawer v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :size="800">
		<el-form ref="dataFormRef" :model="dataForm" :rules="dataRules" label-width="100px" @keyup.enter="submitHandle()">
			<el-form-item label="平台类型" prop="platform">
				<train-dict-select v-model="dataForm.platform" dict-type="mail_platform" placeholder="平台类型" style="width: 100%"></train-dict-select>
			</el-form-item>
			...
			<el-form-item label="状态" prop="status">
				<train-dict-radio v-model="dataForm.status" dict-type="enable_disable"></train-dict-radio>
			</el-form-item>
		</el-form>
		<template #footer>
